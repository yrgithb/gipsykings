...
Note: As of April 2015, @sasoh is suspening his involvement to continue working on other projects. [Windows (x86) build here](https://github.com/yrgithb/gipsykings/tree/master/GipsyKings/Builds). To be continued.
